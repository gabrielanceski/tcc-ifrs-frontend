  ...
  <Modal show @close="emit('close')">
    <div class="w-full p-5">
      ...
      <div class="w-full flex justify-end mt-2">
        <button @click="editUser(id)" class="bg-sky-700 hover:bg-sky-800 text-white font-semibold py-1.5 px-4 rounded focus:outline-none focus:shadow-outline text-sm uppercase flex justify-between space-x-2 items-center">
