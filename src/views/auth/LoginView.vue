    ...
    <Container>
      <div class="grid grid-cols-2 py-5 divide-x">
        ...
        <div class="flex flex-col px-20 space-y-2">
          ...
          <span
            >Para fazer login você deverá usar algum dos seguintes documentos: Matrícula, SIAPE, CPF
            ou CNPJ.</span
          >
          <span
            >Caso não consiga fazer o login, entre em contato com um administrador para a
            recuperação da senha ou o cadastro do usuário.</span
          >
        </div>
      </div>
    </Container>
